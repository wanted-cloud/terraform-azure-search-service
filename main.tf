...
resource "azurerm_search_service" "this" {
  name                = var.name
  resource_group_name = this.azurerm_resource_group.this.name
  location            = var.location != "" ? var.location : this.azurerm_resource_group.this.location
  sku                 = var.sku_name

  authentication_failure_mode              = var.sku_name
